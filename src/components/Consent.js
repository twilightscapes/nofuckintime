...
<CookieConsent
	debug={false}
	location="none"
	style={{ opacity:'1', padding:'3%', margin:'0 auto', border:'0px solid white', position:'relative', top:'0', zIndex:'0', display:'flex', alignSelf:'center', width:'50vw', justifyContent:'center', color:'#fff', background: 'rgba(0,0,0,0.50)', borderRadius:'12px'
   }}
